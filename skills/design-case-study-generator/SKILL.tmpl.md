...
Use the exact card format from `{{{SKILL_INSTALL_PATH}}}/design-case-study-generator/references/pitch-card-template.md`.
...
```bash
bun run {{{SKILL_INSTALL_PATH}}}/design-case-study-generator/scripts/copy-version.ts -- --slug <series-slug> --from vN
```
...
Use the structure in `{{{SKILL_INSTALL_PATH}}}/design-case-study-generator/references/case-study-template.md`.
...
Use `{{{SKILL_INSTALL_PATH}}}/design-case-study-generator/references/token-schema-guidance.md` for naming rules and minimal required token sets.
Use `{{{SKILL_INSTALL_PATH}}}/design-case-study-generator/references/tokens-css-emitter.md` for stable, deterministic `tokens.snapshot.css` emission.
...
Use `{{{SKILL_INSTALL_PATH}}}/design-case-study-generator/references/demo-skeleton.md` as the base structure for `index.html`, `styles.css`, and `app.js` so demos stay consistent **structurally** (not aesthetically) run-to-run.
